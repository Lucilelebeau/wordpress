    ...
    public function widget($args, $instance)
    {
        ...
        echo  '
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control w-75 btn-login" id="email" name="email"  aria-describedby="emailHelp" placeholder="Email" required>
            </div>
            
            <button type="submit" class="btn btn-danger w-25">Entrer</button>
            '. wp_nonce_field('car_form_nonce', 'car_form_nonce').'
