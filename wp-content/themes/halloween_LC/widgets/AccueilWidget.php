...
class AccueilWidget extends WP_widget {
    ...
    {
        parent::__construct('accueil_widget', 
...
echo  '
        <a href="poser-une-question"><button 
            class="btn btn-danger w-75 choix_btn" 
            type="button"  
            name="question">
        ...
        <a href="theme"><button 
            class="btn btn-dark w-75 mt-4 choix_btn"
            type="button"  
            name="reponses">
...
echo $args['after_widget'];
    ...
    public function form($instance){
        ...
        $title = __( 'Default Title', 'accueil_widget_domain' );
