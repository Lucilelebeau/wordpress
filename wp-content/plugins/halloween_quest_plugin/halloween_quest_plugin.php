    ...
    <h1>Supprimer un utilisateur</h1>
        <form action="admin.php?page=manage-read" method="POST">  
            ...
            <div class="card" style="width:400px">
                <img class="card-img-top" src="'.$user->photo.'" alt="Cet utilisateur n\'a pas de photo" style="width:100%">
            <div class="card-body">
            <h4 class="card-title">'.$user->pseudo.'</h4>
            <p class="card-text">Email : '.$user->email.'</p>
            <button type="submit" id="del" class="btn btn-warning w-25">Supprimer</button>
            </div>
            </div>
        </form>
        </div>
